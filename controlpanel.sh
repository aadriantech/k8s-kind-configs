...
capstone_containers=(
    "0ea25d0c23412534359ad34dbaeab38c2016d3b7cf8d8f9e58fae9cb4d93bcce"
    "a5ab71b3046ea733f549417e36a8fc4b0420653c24bd41734d2a5703dadc9619"
    "a7a8d744dce5f49671c3b64e09f1ccd78b9085e509f191c04c61ac8524228c80"
)

sandbox_containers=(
    "a20c11cb07fa63d43d0dbb7b01c035906e8649b6efa671776c28776630de4164"
    "fe987edfdab94a6c25a2761590747e9dc107c6f6f2afb8bc4a9c8bc43b719c8c"
    "20ae925560fd36ddc71b53c04c5eff18bb62508b627524989eda03abc68dccef"
)
...
case $cluster_choice in
    ...
    3)
        ...
        manage_containers "$action" "${capstone_containers[@]}" "${sandbox_containers[@]}"
        ;;
    *)
        echo "Invalid choice. Exiting."
        exit 1
